...
def scrape_utk_catalog_programs(
    url: str = "https://catalog.utk.edu/content.php?catoid=55&navoid=11834",
...
if __name__ == "__main__":
    ...
    if len(df) == 0:
        ...
        # Save result
        df.to_csv("/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/phase-1_output_files_phase-2_input/updated-extracted_uotennessee_knox_gm_programs.csv", index=False)

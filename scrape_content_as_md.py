...
# # Input / Output paths
# # ----------------------------------------------------------
# INPUT_CSV = "/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/latest_input_for_phase-2_scrape/updated-extracted_programs_utulsa_latest_final.csv"               # ← Output from your first script
# OUTPUT_CSV = "/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/latest_output_of_phase-2_scrape/updated-extracted_programs_content_utulsa_latest_final.csv"   # ← Final CSV with content
...
# # Input / Output paths
# # ----------------------------------------------------------
# INPUT_CSV = "/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/latest_input_for_phase-2_scrape/extracted_programs_with_content_minnesota_twin_cities_latest.csv" # ← Output from your first script
# OUTPUT_CSV = "/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/latest_output_of_phase-2_scrape/updated-extracted_programs_content_minnesota_twincities_latest_final.csv" # ← Final CSV with content
# # ----------------------------------------------------------
# # Prefix for PID
# # ----------------------------------------------------------
# PREFIX = "minnesota_twincities_"  # Change this prefix as needed each time you run the code
# # ----------------------------------------------------------
# # NEW: Content cleaning function (preserves markdown structure)
# # ----------------------------------------------------------
# def clean_program_content(raw_markdown: str) -> str:
...
# Input / Output paths
# ----------------------------------------------------------
INPUT_CSV = "/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/phase-1_output_files_phase-2_input/extracted_programs_ugeorgia_latest.csv"
OUTPUT_CSV = "/home/ml-team/Desktop/BackupDisk/uniscrapupbackup/crawling-scrapping/latest_output_of_phase-2_scrape/updated-extracted_programs_content_ugeorgia_2.csv"

# ----------------------------------------------------------
# Prefix for PID
# ----------------------------------------------------------
# PREFIX = "utexus_dellas_"
...
def generate_custom_id(prefix):
    # Ensure the prefix and separator don't exceed 35 characters
    separator = "_"
    prefix_len = len(prefix) + len(separator)
    
    # Generate UUID and slice it to fit the remaining space
    # (36 - prefix_len) calculates how many UUID chars to keep
    ...
    async with AsyncWebCrawler(config=browser_config) as crawler:
        ...
        with open(output_path, 'a' if file_exists else 'w', 
            ...
            for idx, row in enumerate(rows, 1):
                ...
                # Example Usage:
                # If prefix is "USR" (3 chars) + "_" (1 char) = 4 chars
                # It keeps 32 chars of the UUID. Total = 36.
                sanitized_row["id"] = generate_custom_id("uowg")
